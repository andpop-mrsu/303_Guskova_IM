...
$id = $id_max+1;
$specialty_id = $_POST["group_number"][2];
$year = $_POST["group_number"][0];
...
$query3 = "insert into groups(student_id, specialty_id, group_on_course, semester) values(:id, :specialty_id, :group_number, :semester);";
...
<html lang="en">
    <body align="center"><br><br>
        ...
        <form method="post" enctype="application/x-www-form-urlencoded" action="new_student_form.php">
            <p><button style="height:100px;width:200px"><h2>Добавить еще</h2></button></p>
        </form>
    </body>
</html>