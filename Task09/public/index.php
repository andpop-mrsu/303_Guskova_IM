...
<form action="" method="POST">
    <label>
        <select style="height:50px;width:200px;" name="group_on_course">
...
<table class="students-table" cellpadding="8" cellspacing="0" border="1" width="100%" align="center">
    ...
    <?php foreach ($students as $student): ?>
        <tr>
            ...
            <td>
                <a href="edit_student_form.php?student_id=<?= $student['student_card'] ?>">Редактировать</a>
            </td>
            <td>
                <a href="delete_student.php?student_id=<?= $student['student_card'] ?>">Удалить</a>
            </td>
            <td>
                <a href="session_results.php?student_id=<?= $student['student_card'] ?>">Результаты экзаменов</a>
            </td>
        </tr>
    <?php endforeach; ?>
...
<br><br>
<a href="new_student_form.php"><h3>Добавить</h3></a>
